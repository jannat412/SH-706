...
public class NewsActivity extends AppCompatActivity
    ...
    public static final String BROADCAST_SEEKBARMN = "net.shironamhin.shironamhin.activity.sendseekbar";
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            intent = new Intent(BROADCAST_SEEKBARMN);
        ...
        databaseHelper = new DatabaseHelper(NewsActivity.this);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (internetOff == true) {
                    try{
                        ...
                        dialog.dismiss();
                        Toast.makeText(NewsActivity.this, "your song add to playlist", Toast.LENGTH_SHORT).show();
                    }catch (Exception e){
                        e.printStackTrace();
...
//*************************
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!boolMusicPlaying) {
                    ...
                    if (boolMusicPlaying) {
                        Intent intent = new Intent(NewsActivity.this, MiniPlayer.class);
        ...
        builder.setPositiveButton("create playlist", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                switchOn = true;
                Intent intent = new Intent(NewsActivity.this, OnlineActivity.class);
    ...
    private void BufferDialogue() {
        ...
        pdBuff = ProgressDialog.show(NewsActivity.this, "Buffering...",
                "Acquiring song...", true);
    }
    ...
    public void miniNewsPlayer(View view) {
        Intent intent = new Intent(NewsActivity.this, PlayerActivity.class);
        intent.putExtra("internetOn", internetOn);
        intent.putExtra("post_key", album_key);
        startActivity(intent);
    }
    ...
    private long DownloadData(Uri uri, View v) {
        ...
        if (v.getId() == R.id.download)
            request.setDestinationInExternalFilesDir(NewsActivity.this, Environment.DIRECTORY_DOWNLOADS, currentPlayingName + ".mp3");
    ...
    private BroadcastReceiver downloadReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (referenceId == Music_DownloadId) {
                ...
                Toast toast = Toast.makeText(NewsActivity.this,
    ...
    public void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Blog, NewsActivity.NewsviewHolder> firebaseRecyclerAdapter2 = new FirebaseRecyclerAdapter<Blog,
                NewsActivity.NewsviewHolder>(Blog.class, R.layout.news, NewsActivity.NewsviewHolder.class, databaseReferenceNews) {
            @Override
            protected void populateViewHolder(NewsActivity.NewsviewHolder viewHolder, final Blog model, int position) {
            ...
            public void onClick(View v) {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    try {
                        ...
                        btnPlay.setImageResource(R.drawable.miniplay);
                        btnStop.setImageResource(R.drawable.mini_stop);
                        Intent intent = new Intent(NewsActivity.this, Karaokey.class);
                        intent.putExtra("post_key", album_key);
//                        intent.putExtra("currentlyrics", currentlyrics);
                    ...
                    Toast.makeText(NewsActivity.this, "karaoke not supported", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
