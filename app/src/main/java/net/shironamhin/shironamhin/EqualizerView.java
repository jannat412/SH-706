...
/**
 * Created by Jannat Mostafiz on 9/27/2017.
 */
...
public class EqualizerView extends LinearLayout {
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                net.shironamhin.shironamhin.R.styleable.EqualizerView,
                0, 0);

        try {
            foregroundColor = a.getInt(net.shironamhin.shironamhin.R.styleable.EqualizerView_foregroundColor, Color.BLACK);
            duration = a.getInt(net.shironamhin.shironamhin.R.styleable.EqualizerView_animDuration, 3000);
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(net.shironamhin.shironamhin.R.layout.view_equalizer, this, true);
        musicBar1 = findViewById(net.shironamhin.shironamhin.R.id.music_bar1);
        musicBar2 = findViewById(net.shironamhin.shironamhin.R.id.music_bar2);
        musicBar3 = findViewById(net.shironamhin.shironamhin.R.id.music_bar3);
        musicBar4 = findViewById(net.shironamhin.shironamhin.R.id.music_bar4);
        musicBar5 = findViewById(net.shironamhin.shironamhin.R.id.music_bar5);
    ...
    public void animateBars() {
        ...
        if (playingSet == null) {
            ...
            ObjectAnimator scaleYbar4 = ObjectAnimator.ofFloat(musicBar4, "scaleY", 0.2f, 0.8f, 0.1f, 0.1f, 0.3f, 0.1f, 0.2f, 0.8f, 0.7f, 0.2f, 0.8f, 0.9f, 0.7f, 0.6f, 0.1f, 0.3f, 0.1f, 0.4f, 0.1f, 0.5f, 0.7f, 0.9f, 0.5f, 0.4f, 0.3f, 0.1f);
            scaleYbar4.setRepeatCount(ValueAnimator.INFINITE);
            ObjectAnimator scaleYbar5 = ObjectAnimator.ofFloat(musicBar5, "scaleY", 0.3f, 0.5f, 1.0f, 0.4f, 0.3f, 0.1f, 0.6f, 0.3f, 0.5f, 0.1f, 0.3f, 0.5f, 0.3f, 0.7f, 0.8f, 0.9f, 0.3f, 0.1f, 0.5f, 0.3f, 0.6f, 1.0f, 0.8f, 0.2f, 0.4f, 0.1f);
            scaleYbar5.setRepeatCount(ValueAnimator.INFINITE);

            playingSet = new AnimatorSet();
            playingSet.playTogether(scaleYbar4, scaleYbar2, scaleYbar3, scaleYbar1, scaleYbar5);
    ...
    public void stopBars() {
        ...
        if (stopSet == null) {
            ...
            stopSet.playTogether(scaleY5, scaleY4, scaleY3, scaleY2, scaleY1);
